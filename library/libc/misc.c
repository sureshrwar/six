 ...
 */
/* $Header: /cvsroot/six/six/library/libc/misc.c,v 1.1.1.1 2005/03/30 08:40:50 motorbreathing Exp $ */
...
{
	long tz, dst = 3600, sign = 1;
	static char lastTZ[240];
	...
	*_tzname[1] = '\0';
	dststart.ds_type = 'U';
	dststart.ds_sec = 7200;
	dstend.ds_type = 'U';
	dstend.ds_sec = 7200;

	if (strlen(p) > 240) return;
	strcpy(lastTZ, p);
