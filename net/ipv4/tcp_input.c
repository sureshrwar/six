...
static __inline__ void tcp_delack_estimator(struct sock *sk)
{
	/*
...
static __inline__ void tcp_rtt_estimator(struct sock *sk, struct sk_buff *oskb)
{
	long m;
	/*
...
static __inline__ int tcp_sequence(struct sock *sk, u32 seq, u32 end_seq)
{
