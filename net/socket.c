 ...
 *              Alan Cox        :       Asynchronous I/O support (cribbed from t
he
 *                                      tty drivers).
 *              Niibe Yutaka    :       Asynchronous I/O for writes (4.4BSD styl
e)
 ...
 *      paradigm. Because it is very simple it works well for Unix domain socket
s,
...
#define MAX_SOCK_ADDR   128             /* 108 for Unix domain - 16 for IP, 16 f
or IPX, about 80 for AX.25 */
...
#if (SIX)
static __inline struct socket *sockfd_lookup(int fd, struct file **pfile)
#else
