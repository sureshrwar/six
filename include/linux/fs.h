...
struct buffer_head {
        ...
        struct buffer_head * b_this_page;       /* circular list of buffers in o
ne page */
        ...
        struct buffer_head * b_prev;            /* doubly linked list of hash-qu
eue */
...
{
        return test_bit(BH_Uptodate, (int *)&bh->b_state);
}

static inline int buffer_dirty(struct buffer_head * bh)
{
        return test_bit(BH_Dirty, (int *)&bh->b_state);
}

static inline int buffer_locked(struct buffer_head * bh)
{
        return test_bit(BH_Lock, (int *)&bh->b_state);
}

static inline int buffer_req(struct buffer_head * bh)
{
        return test_bit(BH_Req, (int *)&bh->b_state);
}


static inline int buffer_touched(struct buffer_head * bh)
{
        return test_bit(BH_Touched, (int *)&bh->b_state);
}

static inline int buffer_has_aged(struct buffer_head * bh)
{
        return test_bit(BH_Has_aged, (int *)&bh->b_state);
}

static inline int buffer_protected(struct buffer_head * bh)
{
        return test_bit(BH_Protected, (int *)&bh->b_state);
}
...
#if (SIX)
static inline struct inode * iget(struct super_block * sb,int nr)
#else
