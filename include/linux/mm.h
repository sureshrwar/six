...
extern unsigned long __get_free_pages(int priority, unsigned long gfporder, int
dma);
...
static inline struct vm_area_struct * find_vma_intersection (struct task_struct * task, 
