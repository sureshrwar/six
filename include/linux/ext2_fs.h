...
extern void ext2_write_super (struct super_block * sb);
extern void ext2_statfs (struct super_block * sb, struct statfs * buf, int bufsiz);
extern int ext2_remount (struct super_block * sb, int * flags, char * data);
