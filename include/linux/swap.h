...
#if (SIX)
static inline unsigned long in_swap_cache(unsigned long index)
#else
...
#if (SIX)
static inline long find_in_swap_cache(unsigned long index)
#else
...
#if (SIX)
static inline int delete_from_swap_cache(unsigned long index)
#else
