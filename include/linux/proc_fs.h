 ...
 *
 * "get_info" is called when "read", while "fill_inode" is used to
...
extern int proc_register_dynamic(struct proc_dir_entry *, struct proc_dir_entry *);
...
/*
 * These are generic /proc directory-operations: they use the
 * internal tree of "struct proc_dir_entry" to generics
 * the /proc directory.
 */
