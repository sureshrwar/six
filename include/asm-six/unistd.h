...
#ifndef _ASM_SIX_UNISTD_H_
#define _ASM_SIX_UNISTD_H_
...
#define __NR_setup                0     /* used only by init, to get system goin
g */
#define __NR_exit                 1
#define __NR_fork                 2
#define __NR_read                 3
 ...
 */
static inline int sys_execve(char * file, char ** argvp, char ** envp)
{
        int i;
	syscall(__NR_execve, (long)file, (long)argvp, (long)envp);
        return -1;
}
